...
function defineStocktakingModel(sequelize, models) {
	...
	if (models) {
		if (models.StationModel) {
			StocktakingModel.belongsTo(models.StationModel, {
				foreignKey: "station_id",
			});
		}
		if (models.SubstanceModel) {
			StocktakingModel.belongsTo(models.SubstanceModel, {
...
module.exports = defineStocktakingModel;
